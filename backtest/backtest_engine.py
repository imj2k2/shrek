        ...
        for idx, date in enumerate(dates):
            ...
            if not trading_halted:
                ...
                for symbol in symbols:
                    ...
                    # Only use this if no valid signal was generated by the agent
                    force_trade_generation = False  # Disabled by default
                    
                    # Only force trades if we didn't get a valid signal and it's a good time to do so
